...
namespace LoKi {
   ...
   *  @date   2011-01-31
   */
  class SeedFinderNTrks : public virtual IJetMaker, public GaudiTool {
  public:
     ...
     *
     */
    SeedFinderNTrks( const std::string& type, const std::string& name, const IInterface* parent )
  ...
  private:
    ...
    bool twoTrkSeeding( LHCb::Particle::ConstVector& PartIPK0Sub, LHCb::VertexBase* RecVert,
                        std::vector<LHCb::VertexBase*>, Gaudi::XYZPoint BL_P, Gaudi::LorentzVector BL_M,
                        IJetMaker::Jets& Seeds ) const;
