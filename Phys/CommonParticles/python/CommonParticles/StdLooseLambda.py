...
# =============================================================================
__all__ = ('StdLooseLambdaLL', 'StdLooseLambdaDD', 'StdLooseLambdaLD',
           'locations')
# =============================================================================
...
StdLooseLambdaLDpLong.Inputs = [
    "Phys/StdLooseProtons/Particles", "Phys/StdNoPIDsDownPions/Particles"
]

StdLooseLambdaLDpLong.DaughtersCuts = {
    "p+": "(ISLONG) & (P>2*GeV) & (MIPCHI2DV(PRIMARY)>9)",
...
StdLooseLambdaLDpDown.Inputs = [
    "Phys/StdNoPIDsDownProtons/Particles", "Phys/StdLoosePions/Particles"
]

StdLooseLambdaLDpDown.DaughtersCuts = {
    "p+": "(ISDOWN) & (P>2*GeV) & (MIPCHI2DV(PRIMARY)>4)",
...
StdLooseLambdaLD.Inputs = [
    "Phys/StdLooseLambdaLDpLong/Particles",
