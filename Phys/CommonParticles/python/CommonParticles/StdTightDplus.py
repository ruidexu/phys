...
# =============================================================================
__all__ = ('StdTightDplus2KPiPiOppSignPi', 'StdVeryTightDsplus2KKPi',
           'locations')
...
StdTightDplus2KPiPiOppSignPi.Inputs = [
...
StdVeryTightDsplus2KKPi.Inputs = [
    "Phys/StdLooseKaons/Particles", "Phys/StdLoosePions/Particles"
]
...
StdTightDplus2PiPiPi.DaughtersCuts = {
    "pi+": "(P > 2*GeV)  & ((PIDK-PIDpi) < 3.) & ((MIPCHI2DV(PRIMARY)) > 6.0 )"
}
