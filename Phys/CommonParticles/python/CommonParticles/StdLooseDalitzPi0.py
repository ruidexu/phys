...
pi02gee = CombineParticles(
    "StdLoosePi02gee", DecayDescriptor='pi0 -> gamma gamma')
pi02gee.Inputs = [
...
pi024e = CombineParticles(
    "StdLoosePi024e", DecayDescriptor='pi0 -> gamma gamma')
pi024e.Inputs = [
    "Phys/StdAllLooseGammaLL/Particles", "Phys/StdAllLooseGammaDD/Particles"
]
...
pi0Dalitz = CombineParticles(
    "StdLooseDalitzPi0", DecayDescriptor='pi0 -> gamma gamma')
pi0Dalitz.Inputs = [
    "Phys/StdLooseAllPhotons/Particles", "Phys/StdDiElectronGamma/Particles"
]
