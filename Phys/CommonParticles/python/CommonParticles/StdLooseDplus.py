...
#
StdLooseDplus2KPiPiOppSignPi = StdLooseDplus2KPiPi.clone(
...
StdLooseDplus2KKK.DaughtersCuts = {
    "K+":
    "(PT > 250*MeV) & (P > 2000*MeV) &((MIPCHI2DV(PRIMARY)) > 2.0 ) & (PIDK-PIDpi > 3.0)"
}
...
StdLooseDsplus2KKPiOppSign.Inputs = [
    "Phys/StdLooseKaons/Particles", "Phys/StdLoosePions/Particles"
]
StdLooseDsplus2KKPiOppSign.DecayDescriptor = "[D_s+ -> pi- K+ K+]cc"
StdLooseDsplus2KKPiOppSign.DaughtersCuts = {
    "K+":
    "(PT > 250*MeV) & (P > 2000*MeV) &((MIPCHI2DV(PRIMARY)) > 2.5 ) & (PIDK-PIDpi > 3.0)",
    "pi+":
    "(PT > 250*MeV) & (P > 2000*MeV) &((MIPCHI2DV(PRIMARY)) > 2.5 ) & (PIDK-PIDpi < 10.0)"
}
