...
StdLooseDstarWithD02KK.Inputs = [
    "Phys/StdAllLoosePions/Particles", "Phys/StdLooseD02KK/Particles"
]
## configure Data-On-Demand service
...
#
StdLooseDstarWithD02PiPi = StdLooseDstarWithD02KK.clone(
    "StdLooseDstarWithD02PiPi")
GaudiSequencer("SeqStdLooseDstarWithD02PiPi").Members += [
    StdLooseDstarWithD02PiPi
]
StdLooseDstarWithD02PiPi.Inputs = [
    "Phys/StdAllLoosePions/Particles", "Phys/StdLooseD02PiPi/Particles"
]
## configure Data-On-Demand service
