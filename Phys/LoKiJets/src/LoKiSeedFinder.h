...
namespace LoKi {
   ...
   *  @date   2011-01-31
   */
  class SeedFinder : public virtual IJetMaker, public GaudiTool {
  public:
     ...
     *
     */
    SeedFinder( const std::string& type, const std::string& name, const IInterface* parent )
...

    {
      ...
      declareProperty( "vetoPV", m_PVveto,
                       "exclude vertex near to any PV with distance fixe by 'SeedTseedVtxMinAnyPV' and exclude the trk "
                       "associated to any PV to construct a secondary vtx" );
      //   declareProperty ( "SeedMaxDirAngle"         , m_dirAng          , "Max direction angle btw the seed momentum
      //   and the direction vtx-> seed"  );
    }
...
class sortDauPt {
public:
  inline bool operator()( LHCb::Particle* obj1, LHCb::Particle* obj2 ) {
...
public:
  inline bool operator()( LHCb::Particle* obj1, LHCb::Particle* obj2 ) {
    ...
    Gaudi::XYZVector seedd1 = Gaudi::XYZVector( Gaudi::XYZPoint( obj1->endVertex()->position() ) -
                                                Gaudi::XYZPoint( obj1->referencePoint() ) );
    Gaudi::XYZVector seedd2 = Gaudi::XYZVector( Gaudi::XYZPoint( obj2->endVertex()->position() ) -
...
public:
  inline bool operator()( LHCb::Particle* obj1, LHCb::Particle* obj2 ) {
    ...
    double combo1 = 1000 * 1000 * ( dotprod1 * obj1->endVertex()->chi2PerDoF() ) /
                    ( obj1->daughtersVector().size() * obj1->pt() * obj1->pt() );
    double combo2 = 1000 * 1000 * ( dotprod2 * obj2->endVertex()->chi2PerDoF() ) /
                    ( obj2->daughtersVector().size() * obj2->pt() * obj2->pt() );
...
class sortPt {
public:
  inline bool operator()( LHCb::Particle* obj1, LHCb::Particle* obj2 ) { return obj1->pt() > obj2->pt(); }
};
