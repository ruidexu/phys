...
namespace LoKi {
   ...
   *  @date   2011-01-31
   */
  class VVSeedFinder : public virtual IJetMaker, public GaudiTool {
  public:
     ...
     *        @link http://cdsweb.cern.ch/record/1211038/files/LHCb-INT-2009-023.pdf LHCb-INT-2009-023 - Bay/Potterat
     * @endlink
     *        @link http://cdsweb.cern.ch/record/1266883/files/CERN-THESIS-2010-074.pdf CERN_THESIS-2010-074 - Potterat
     * @endlink
     *
     */
    VVSeedFinder( const std::string& type, const std::string& name, const IInterface* parent )
  ...
  protected:
    ...
    IJetMaker::Jets JetCone( const double& Rmax, IJetMaker::Jets& seeds, const IJetMaker::Input& inputs ) const;

    IJetMaker::Jets FilterProtoJets( const double& DeltaRSeeds, IJetMaker::Jets& ProtoJets ) const;
