...
namespace LoKi {
   ...
   *  @date   2011-01-31
   */
  class SeedConeJetMaker : public virtual IJetMaker, public GaudiTool {
  public:
     ...
     *
     */
    SeedConeJetMaker( const std::string& type, const std::string& name, const IInterface* parent )
  ...
  protected:
    ...
    IJetMaker::Jets JetConePurged( const double& Rmax, IJetMaker::Jets& seeds, const IJetMaker::Input& inputs ) const;
  };
} // namespace LoKi
