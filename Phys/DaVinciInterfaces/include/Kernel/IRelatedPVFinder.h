 ...
 *  @date   2008-09-29
 */
struct GAUDI_API IRelatedPVFinder : virtual public IAlgTool {
  ...
  virtual const LHCb::VertexBase* relatedPV( const LHCb::Particle*                particle,
                                             const LHCb::VertexBase::ConstVector& PVs ) const                      = 0;
  virtual const LHCb::VertexBase* relatedPV( const LHCb::Particle* particle, const std::string& PVLocation ) const = 0;
};
