...
struct GAUDI_API IVertexFit : extend_interfaces<IParticleCombiner, IParticleReFitter> {
   ...
   *  @return status code
   */
  virtual StatusCode fit( LHCb::Vertex& vertex, const LHCb::Particle::ConstVector& daughters ) const = 0;
  // ==========================================================================
  /** the vertex fitting method without creation of a Particle,
  ...
  inline StatusCode fit( LHCb::Vertex& vertex, DAUGHTER begin, DAUGHTER end ) const {
   ...
   *  @todo test
   */
  inline StatusCode fit( LHCb::Vertex& vertex, const LHCb::Particle& daughter0,
   ...
   *  @todo test
   */
  inline StatusCode fit( LHCb::Vertex& vertex, const LHCb::Particle& daughter0, const LHCb::Particle& daughter1,
...
public:
   ...
   *  @return status code
   */
  virtual StatusCode fit( const LHCb::Particle::ConstVector& daughters, LHCb::Vertex& vertex,
   ...
   */
  template <class DAUGHTER>
  inline StatusCode fit( DAUGHTER begin, DAUGHTER end, LHCb::Vertex& vertex, LHCb::Particle& particle ) const {
   ...
   *  @todo test
   */
  inline StatusCode fit( const LHCb::Particle& daughter0, const LHCb::Particle& daughter1, LHCb::Vertex& vertex,
   ...
   *  @todo test
   */
  inline StatusCode fit( const LHCb::Particle& daughter0, const LHCb::Particle& daughter1,
                         const LHCb::Particle& daughter2, LHCb::Vertex& vertex, LHCb::Particle& particle ) const {
    const LHCb::Particle::ConstVector tmp = {&daughter0, &daughter1, &daughter2};
    return fit( tmp, vertex, particle );
  }
  // ==========================================================================
public:
   ...
   *  @return status code
   */
  virtual StatusCode add( const LHCb::Particle* particle, LHCb::Vertex& vertex ) const = 0;
  // ==========================================================================
   ...
   *  @return status code
   */
  virtual StatusCode remove( const LHCb::Particle* particle, LHCb::Vertex& vertex ) const = 0;
  // ==========================================================================
};
// ============================================================================
// The END
